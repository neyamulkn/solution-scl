            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-layout-grid2"></i><span class="hide-menu">Academic Info</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('/academic/class/list')}}">Class</a></li>
                                <li><a href="{{url('/academic/subject/list')}}">Subject</a></li>
                                <li><a href="{{url('/academic/section/list')}}">Section</a></li>
                                <li><a href="{{url('/academic/shift/list')}}">Shift</a></li>
                            </ul>
                        </li>
                        <li> <a class="has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false"><i class="ti-email"></i><span class="hide-menu">Student</span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="{{url('/student/list')}}">Student list</a></li>
                                <li><a href="{{url('/student/add')}}">Admit Student</a></li>
                                <li><a href="{{url('/student/add')}}">Manage Student</a></li>
                            </ul>
                        </li>
