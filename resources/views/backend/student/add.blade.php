                                ...
                                <form action="{{url('student/store')}}" method="post" enctype="multipart/form-data" class="validation-wizard wizard-circle">
                                    ...
                                    <section>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-lg-4">
                                                    <label for="health_condition" class="block">Health Condition</label>
                                                   <input id="health_condition" name="health_condition" type="text" class="form-control" placeholder="Health Condition">
                                                </div>
                                    ...
                                    <section>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-lg-4">
                                                    ...
                                                    <input id="mobile"  value="{{old('stn_mobile')}}" placeholder="Mobile no" name="stn_mobile" type="text" class="required form-control">
                                                </div>

                                                <div class="col-sm-4 col-lg-4">
                                                    <label for="lg_name" class="block">Local Guardian <span class="star_mark">*</span></label>
                                               
                                                    <input id="lg_name" name="lg_name" type="text" class="form-control required" value="{{old('lg_name')}}" placeholder="Enter Local Guardian Name">
                                                </div>
                                    ...
                                    <section>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-4 col-lg-4">
                                                    <label for="fa_phato" class="block">Father Phato</label>
                                                
                                                    <input id="fa_phato" name="fa_phato" type="file" class="form-control" value="{{old('fa_phato')}}">
                                                </div>
                                            </div>
                                            <div class="form-group row">
                                                <div class="col-sm-4 col-lg-4">
                                                ...
                                                <div class="col-sm-4 col-lg-4">
                                                    <label for="fa_phato" class="block">Mother Phato</label>
                                                
                                                    <input id="ma_phato" name="ma_phato" type="file" class="form-control" value="{{old('ma_phato')}}">
                                                </div>
                                            </div>
